...
import de.rrze.idmone.utils.jpwgen.options.AtLeast2DigitsOption;
import de.rrze.idmone.utils.jpwgen.options.AtLeast2SymbolsOption;
import de.rrze.idmone.utils.jpwgen.options.EndsNoDigitOption;
import de.rrze.idmone.utils.jpwgen.options.EndsNoSmallLetterOption;
import de.rrze.idmone.utils.jpwgen.options.EndsNoSymbolOption;
import de.rrze.idmone.utils.jpwgen.options.EndsNoUpperLetterOption;
import de.rrze.idmone.utils.jpwgen.options.IPwOption;
import de.rrze.idmone.utils.jpwgen.options.MaxAttempts;
import de.rrze.idmone.utils.jpwgen.options.Only1CapitalOption;
import de.rrze.idmone.utils.jpwgen.options.Only1DigitOption;
import de.rrze.idmone.utils.jpwgen.options.Only1SymbolOption;
import de.rrze.idmone.utils.jpwgen.options.PwAmbiguousOption;
import de.rrze.idmone.utils.jpwgen.options.PwCapitalizeOption;
import de.rrze.idmone.utils.jpwgen.options.PwColumnOptions;
import de.rrze.idmone.utils.jpwgen.options.PwNumberPassword;
import de.rrze.idmone.utils.jpwgen.options.PwNumeralsOption;
import de.rrze.idmone.utils.jpwgen.options.PwOptionFlag;
import de.rrze.idmone.utils.jpwgen.options.PwOptionSwitch;
import de.rrze.idmone.utils.jpwgen.options.PwPasswordLength;
import de.rrze.idmone.utils.jpwgen.options.PwRandomOption;
import de.rrze.idmone.utils.jpwgen.options.PwSymbolsOption;
import de.rrze.idmone.utils.jpwgen.options.PwTermWidth;
import de.rrze.idmone.utils.jpwgen.options.SRAlgorithm;
import de.rrze.idmone.utils.jpwgen.options.StartsNoDigitOption;
import de.rrze.idmone.utils.jpwgen.options.StartsNoSmallLetterOption;
import de.rrze.idmone.utils.jpwgen.options.StartsNoSymbolOption;
import de.rrze.idmone.utils.jpwgen.options.StartsNoUpperLetterOption;
...
public class PwGeneratorOptionBuilder
{
	...
	public PwGeneratorOptionBuilder setTermWidth(int clTermWidth)
	{
		PwOptionFlag flag = new PwTermWidth();
		flag.setValue(Integer.toString(clTermWidth));
		_flags.add(flag);
		return this;
	}
